...
public class ActivityArtist extends AppCompatActivity {
    ...
    ArtistObject currentArtist = FragmentArtists.currentArtist;
    ListView listView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        listView = (ListView) findViewById(R.id.artistSongList);
        adapter = new AdapterTracks( this, R.layout.item_list_view2, currentArtist.songObjectList); //takes context
        listView.setAdapter(adapter);

        if(!StaticMusicPlayer.musicIsPlaying && !StaticMusicPlayer.isPaused){StaticMusicPlayer.setList(currentArtist.songObjectList);}
    ...
    public ArrayList<SongObject> returnShuffledList(){
        ...
        ArrayList<SongObject> copy = new ArrayList<SongObject>(currentArtist.songObjectList.size());

        for (SongObject foo: currentArtist.songObjectList) {
    ...
    private void setListItemClickListener(){
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> arg0, View arg1, int arg2, long arg3) {
                ...
                StaticMusicPlayer.setList(currentArtist.songObjectList);
                StaticMusicPlayer.tryToPlaySong(currentArtist.songObjectList.get(arg2)); // arg2 is a sonObject
